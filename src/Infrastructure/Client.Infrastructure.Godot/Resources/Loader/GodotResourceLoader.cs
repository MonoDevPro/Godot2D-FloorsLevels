using Godot;
using GodotFloorLevels.Scripts.Application.Exceptions;
using static Godot.ResourceLoader;

namespace Client.Infrastructure.Godot.Resources.Loader;

/// <summary>
/// Serviço de carregamento de recursos para um client de jogo 2D em Godot 4.4.
/// </summary>
public sealed partial class GodotResourceLoader : Resource
{
    ...
    private static bool ValidateResourceExists<T>(string path, string typeHint = "") where T : Resource
    {
    ...
    /// </summary>
    private static bool TryGetResourceAvailableFromCache<T>(string path, CacheMode cacheMode, out T? resource) where T : Resource
    {
        resource = null;
