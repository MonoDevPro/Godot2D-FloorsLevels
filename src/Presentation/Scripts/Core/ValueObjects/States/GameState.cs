namespace GodotFloorLevels.Scripts.Core.ValueObjects.States;

/// <summary>
/// Value Object que encapsula o estado do jogo.
/// </summary>
public readonly record struct GameState(GameState.States State = GameState.States.MenuInicial)
{
    public enum States
    {
        MenuInicial,
